...
export default function ConceptCard({card, height, initialScrollOffset = 0, onScrollOffset, onToggleFavorite}: Props) {
  ...
  return (
    <View testID={`card-${card.id}`} style={[styles.frame, {height}]}>
      <ScrollView
        ...
        <Section label="寓言故事"><Text selectable style={styles.body}>{card.fable}</Text></Section>
        <Section label="核心公式">
...
const styles = StyleSheet.create({
  ...
  section: {paddingVertical: 15, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border}, label: {fontSize: 13, fontWeight: '700', color: colors.muted, marginBottom: 7},
